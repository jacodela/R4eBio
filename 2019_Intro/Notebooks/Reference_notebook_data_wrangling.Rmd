...
We can combine multiple variables to be used by `group_by()`. If we were interested in seeing how the values per continents change with time, with can combine year and continent
