...
What is the difference in caratage and price between the 99th percentile "Premium" diamond and the 99th percentile "Very Good" diamond?

```{r}
aggregate(price ~ cut, diamonds, quantile, probs = 0.90)
```
